	...
	rules: []*rule{
		{
			...
			expr: &choiceExpr{
				...
				alternatives: []interface{}{
					&seqExpr{
						pos:        position{line: 5, col: 5, offset: 30},
						exprsTypes: []int{labeledExp, notCodeExp},
						exprs: []interface{}{
							&labeledExpr{
								pos:      position{line: 5, col: 5, offset: 30},
								label:    "a",
					...
					&seqExpr{
						...
						exprsTypes: []int{labeledExp, andCodeExp},
						exprs: []interface{}{
							&labeledExpr{
								pos:      position{line: 15, col: 3, offset: 165},
								label:    "d",
							...
							exprs: []interface{}{
								&labeledExpr{
									...
									expr: &seqExpr{
										...
										exprsTypes: []int{charClassMatcherExp, labeledExp, andCodeExp},
										exprs: []interface{}{
											&charClassMatcher{
												pos:        position{line: 20, col: 19, offset: 250},
												val:        "[^abd]",
		...
		},
		{
			...
			expr: &actionExpr{
				...
				expr: &seqExpr{
					pos:        position{line: 22, col: 5, offset: 340},
					exprsTypes: []int{andExp, labeledExp},
					exprs: []interface{}{
						&andExpr{
							pos:      position{line: 22, col: 5, offset: 340},
							exprType: labeledExp,
