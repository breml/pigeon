	...
	rules: []*rule{
		{
			...
			expr: &actionExpr{
				pos: position{line: 6, col: 11, offset: 62},
				run: (*parser).callonSearch1,
				expr: &oneOrMoreExpr{
					pos: position{line: 6, col: 11, offset: 62},
					expr: &anyMatcher{
						line: 6, col: 11, offset: 62,
					},
				},
			},
		},
		{
			name: "EOF",
			pos:  position{line: 10, col: 1, offset: 134},
			expr: &notExpr{
				pos: position{line: 10, col: 8, offset: 141},
				expr: &anyMatcher{
					line: 10, col: 9, offset: 142,
				},
			},
		},
	},
...
func (c *current) onSearch1() (interface{}, error) {
