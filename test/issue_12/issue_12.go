	...
	rules: []*rule{
		{
			...
			expr: &seqExpr{
				...
				exprsTypes: []int{choiceExp, zeroOrMoreExp, ruleRefExp},
				exprs: []interface{}{
					&choiceExpr{
						pos:               position{line: 10, col: 10, offset: 113},
						alternativesTypes: []int{seqExp, seqExp, seqExp, seqExp, seqExp, seqExp},
						alternatives: []interface{}{
							&seqExpr{
								pos:        position{line: 10, col: 10, offset: 113},
								exprsTypes: []int{ruleRefExp, zeroOrOneExp},
								exprs: []interface{}{
									&ruleRefExpr{
										pos:  position{line: 10, col: 10, offset: 113},
										name: "L",
